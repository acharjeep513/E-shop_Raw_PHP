<?php
    ...
    class DBProduct
    {
        ...
        public function addProduct($category,$name,$unit,$beforeDiscount, $afterDiscount,$qtn)
        {
            $sql="INSERT into $this->table(category,name,unit,beforeDiscount,afterDiscount,qtn)
			values (:category,:name,:unit,:beforeDiscount,:afterDiscount,:qtn)";
            $stmt=DB::prepare($sql);
